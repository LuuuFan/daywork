...
RSpec.describe CheersController, type: :controller do
  ...
  describe "GET #edit" do
    it "returns a success response" do
      cheer = Cheer.create! valid_attributes
      get :edit, params: {id: cheer.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created cheer" do
        post :create, params: {cheer: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Cheer.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the cheer" do
        cheer = Cheer.create! valid_attributes
        put :update, params: {id: cheer.to_param, cheer: valid_attributes}, session: valid_session
        expect(response).to redirect_to(cheer)
      end
    end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the cheers list" do
      cheer = Cheer.create! valid_attributes
      delete :destroy, params: {id: cheer.to_param}, session: valid_session
      expect(response).to redirect_to(cheers_url)
    end
  end
